...
def index_docs():
    ...
    # initializing the embedding models : turns text into vectors
    try:
    ...
    try:
        logger.info("Initializing Azure AI Search VErtor Store.....")
        embeddings = AzureOpenAIEmbeddings(
    ...
    for pdf_path in pdf_files:
        ...
        # Upload to Azure
        if all_splits:
            logger.info(f"Uploading{len(all_splits)} to Azure AI Search index '{index_name}'")
            try:
